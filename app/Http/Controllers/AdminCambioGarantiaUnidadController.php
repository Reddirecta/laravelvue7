<?php namespace App\Http\Controllers;
	...
	class AdminCambioGarantiaUnidadController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "con_aa_garantias_unidad";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Serie","name"=>"serie"];
			$this->col[] = ["label"=>"Suc","name"=>"suc_id","join"=>"con_aa_sucursales,sucursal"];
			$this->col[] = ["label"=>"Usuario","name"=>"usuario_id","join"=>"con_aa_usuarios,usuario"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Serie','name'=>'serie','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-5','readonly'=>'true'];
