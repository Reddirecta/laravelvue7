<?php namespace App\Http\Controllers;
	...
	class AdminOrdenesServicioController extends \crocodicstudio\crudbooster\controllers\CBController {

		public function getIndex()
		{
			$data['page_title'] = "Ordenes de Servicio";
			$data['page_menu'] = 'Ordenes de Servicio';
			$data['module->name'] = 'Ordenes de Servicio';
			$data['load_css'][] = asset("https://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700,900");
			$data['load_css'][] = asset("https://cdn.jsdelivr.net/npm/@mdi/font@5.x/css/materialdesignicons.min.css");
			$data['load_css'][] = asset("https://cdn.jsdelivr.net/npm/vuetify@2.x/dist/vuetify.min.css");
//			$data['load_js'][] = asset("/vendor/crudbooster/assets/adminlte/plugins/datepicker/locales/bootstrap-datepicker.es.js");
			$data['load_js'][] = asset("https://cdn.jsdelivr.net/npm/vue@2.x/dist/vue.js");
			$data['load_js'][] = asset("https://cdn.jsdelivr.net/npm/vuetify@2.x/dist/vuetify.js");
			$data['load_js'][] = asset("https://cdnjs.cloudflare.com/ajax/libs/axios/0.20.0/axios.min.js");
			$data['load_js'][] = asset("https://cdnjs.cloudflare.com/ajax/libs/axios/0.20.0/axios.min.map");
			$data['load_js'][] = asset("js/components/motocheck/OrdenesServicio.js");
//			$data['os'] = DB::table('laravelvue.users')
//			->select('name','id')
//			->get()->toArray();
			//Route::getCurrentRoute()->getActionName();
			return view('OrdenesServicio',$data);
		}
